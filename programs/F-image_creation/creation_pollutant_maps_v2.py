...
for pollutant in pollutant_directories :
    ...
    for mean in mean_directories:
        ...
        for map_csv_format in map_csv_format_list :
            ...
            path_map_out=os.path.join(path_treated_data_directory,pollutant,"cartes_de_pollution",map_csv_format).replace(".csv",".png")
            ...
            if(len(rgb_matrixes)!=1):
                ...
                for i,matrix in enumerate(rgb_matrixes):
                    ...
                    Image.fromarray(matrix).resize(size_image).save(path_map_out_final+"."+format_image)
                    
                    
            else:
                Image.fromarray(rgb_matrixes[0]).resize(size_image).save(path_map_out+"."+format_image)
